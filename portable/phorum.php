...
// LibreForum wrapper to create a portable, dynamic LibreForum with a single code base
// and to safely wrap LibreForum to protect it from other applications. 
...
// we set $PHORUM["CUSTOM_QUERY_STRING"] so LibreForum will parse it instead of
...
// create a namespace for LibreForum
