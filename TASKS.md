[x] Change the github repository from OpenPhorum to LibreForum (Submodule URLs synchronized to LibreForum)
[x] Move the license text from docs to main directory. (Moved to forum/LICENSE)
[] Can we switch back at some to Apache license? (See response below)
