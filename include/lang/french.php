...
//    $PHORUM['DATA']['CHARSET'] = "iso8859-1";
    ...
    $PHORUM["DATA"]["LANG"]=array(
				...
				"EnableNotifyDefault"   =>      "Suivi des discussions",
				"NotifyDefaultNone"   =>      "ne pas les suivre",
				"NotifyDefaultFollow"   =>      "les suivre sans courriel (visibles dans les discussions suivies)",
				...
				"NotifyDefaultHelp"   =>      "Les cases « Suivre » de chaque nouveau message sont cochées d'après votre réglage « Suivi des discussions », dans les options de forum. Ce réglage ne modifie pas les discussions déjà suivies, listées ci-dessous.",
				"Error"   =>      "Erreur",
