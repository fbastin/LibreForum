...
//    $PHORUM['DATA']['CHARSET'] = "iso8859-1";
    ...
    $PHORUM["DATA"]["LANG"]=array(
				...
				"EmailReplies"   =>      "Envoyer les réponses de cette discussion sur ma messagerie",
				...
				"EnableNotifyDefault"   =>      "Quand j'écris dans une discussion",
				"NotifyDefaultNone"   =>      "ne pas la suivre",
				"NotifyDefaultFollow"   =>      "la suivre, sans courriel",
				"NotifyDefaultEmail"   =>      "la suivre et recevoir un courriel à chaque réponse",
				"NotifyDefaultChange"   =>      "Changer ce réglage par défaut",
				"NotifyDefaultHelp"   =>      "Les cases « Suivre » de chaque nouveau message sont cochées d'après votre réglage « Quand j'écris dans une discussion », dans les options de forum. Ce réglage ne modifie pas les discussions déjà suivies, listées ci-dessous.",
				"Error"   =>      "Erreur",
