<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "EnableNotifyDefault"   =>      "Following discussions",
        "NotifyDefaultNone"     =>      "do not follow them",
        "NotifyDefaultFollow"   =>      "follow them without e-mail (listed in your followed threads)",
        ...
        "NotifyDefaultHelp"     =>      "The “Follow” boxes of every new message are ticked according to your “Following discussions” setting, in the forum options. This setting does not change the discussions you already follow, listed below.",
        "Error"                 =>      "Error",
