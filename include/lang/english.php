<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "EnableNotifyDefault"   =>      "When I write in a discussion",
        "NotifyDefaultNone"     =>      "do not follow it",
        "NotifyDefaultFollow"   =>      "follow it, without e-mail",
        "NotifyDefaultEmail"    =>      "follow it and get an e-mail for each reply",
        "NotifyDefaultChange"   =>      "Change this default",
        "NotifyDefaultHelp"     =>      "The “Follow” boxes of every new message are ticked according to your “When I write in a discussion” setting, in the forum options. This setting does not change the discussions you already follow, listed below.",
        "Error"                 =>      "Error",
