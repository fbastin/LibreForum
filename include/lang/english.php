<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "EmailReplies"          =>      "Notify me of new replies by e-mail (a single e-mail until I next read the discussion)",
        "Email"                 =>      "Email",
        ...
        "EnableNotifyDefault"   =>      "Following the discussions I take part in",
        "NotifyDefaultNone"     =>      "do not follow them",
        "NotifyDefaultFollow"   =>      "follow them without e-mail (they appear under “View followed threads”)",
        "NotifyDefaultEmail"    =>      "follow them and notify me of new replies by e-mail",
        "NotifyDefaultChange"   =>      "Change this default",
        "NotifyDefaultNote"   =>      "E-mail notification: a single e-mail at the first reply, then nothing until you open the discussion.",
        "NotifyDefaultHelp"     =>      "The “Follow” boxes of every new message are ticked according to your “Following the discussions I take part in” setting, in the forum options. This setting does not change the discussions you already follow, listed below.",
        "Error"                 =>      "Error",
        ...
        "RegApprovedEmailBody"  =>      "Good news: your account on $PHORUM[title] has just been approved by the moderation team.\n\nYou can now sign in and join the discussions:\n\n".phorum_get_url(PHORUM_LOGIN_URL)."\n\nSee you on the forum,\nThe $PHORUM[title] team",
