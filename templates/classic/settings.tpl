...
{VAR marker '<img src="templates/classic/images/carat.png" border="0" width="8" height="8" alt="" />'}

{! -- This is the image to use as a delete button for recipients in PM --- }
{VAR delete_image "templates/classic/images/delete.png"}

{! -- This is the image for the gauge bar to show how full the PM box is -- }
{VAR gauge_image "templates/classic/images/gauge.png"}
