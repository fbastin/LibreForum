...
// $selectedBg = "$bkgd[$i]"; // set variable equal to which random filename was chosen
?>
...
{IF PRINTVIEW}
  ...
  <meta name="keywords" content="tir, tireur, shooting, firearms, armes, rechargement, Belgique, Europe, munitions, tireur.org" />
...
{ELSE}
  ...
  <link rel="stylesheet" type="text/css"  href="/css/tireur.css?v=20260524a" media="all"/>
{/IF}
