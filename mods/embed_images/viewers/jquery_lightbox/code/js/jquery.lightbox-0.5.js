...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'images/lightbox-ico-loading.png',		// (string) Path and the name of the loading icon
			...
			imageBlank:				'images/lightbox-blank.png',			// (string) Path and the name of a blank image (one pixel)
					...
					<div id="lightbox-container-image">
						...
						<div id="lightbox-loading">
							<a href="#" id="lightbox-loading-link">
								<img src="../images/lightbox-ico-loading.png">
							</a>
						</div>
					</div>
				</div>
					...
					<div id="lightbox-container-image-data">
						...
						<div id="lightbox-secNav">
							<a href="#" id="lightbox-secNav-btnClose">
								<img src="../images/lightbox-btn-close.png">
							</a>
						</div>
					</div>
				</div>
