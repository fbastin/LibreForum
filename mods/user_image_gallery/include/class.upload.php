...
// |                                                                        |
// | This software has been modified in accordance with the terms of the    |
// | license. Necessary modified terms of the license are in effect. The    |
// | modifications were done by James Lehmann in October and November 2009. |
// |                                                                        |
...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->lang               = $lang;
        if ($this->lang != 'en_GB' && file_exists(dirname(__FILE__).'/class.upload.' . $lang . '.php')) {
            $translationx = null;
            include(dirname(__FILE__).'/class.upload.' . $lang . '.php');
            if (is_array($translationx)) {
                $this->translation = array_merge($this->translation, $translationx);
            } else {
                $this->lang = 'en_GB';
            }
        }
