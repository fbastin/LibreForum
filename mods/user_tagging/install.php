...
// adding the custom user field "mod_user_tagging" to LibreForum.
...
$existing = phorum_api_custom_profile_field_byname("mod_user_tagging");
...
phorum_db_update_settings(array("mod_user_tagging_installed" => 1));
