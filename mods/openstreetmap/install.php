...
// adding the custom user field "mod_openstreetmap" to LibreForum.
...
$existing = phorum_api_custom_profile_field_byname("mod_openstreetmap");
...
phorum_db_update_settings(array("mod_openstreetmap_installed" => 1));
